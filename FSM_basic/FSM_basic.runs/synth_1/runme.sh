...
HD_PWD='C:/Users/aabha/OneDrive/Desktop/verilog/FSM_basic/FSM_basic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cyclic_lamp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cyclic_lamp.tcl
